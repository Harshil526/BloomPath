...
import PostTask from "@/components/employer/PostTask";
import WorkerList from "@/components/employer/WorkerList";
...
const EmployerDashboard = () => {
  ...
  const navItems = [
    ...
    { path: "/employer/post", label: "Post Task", icon: PlusCircle },
    { path: "/employer/workers", label: "Workers", icon: Users },
